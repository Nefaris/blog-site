  ...
  <section className="py-5">
    <div className="container">
      <div className="text-center mb-5">
        ...
        <h2 className="display-5 fw-bold mt-3">Lorem ipsum dolor</h2>
      </div>
      <div className="row">
        <div className="col-12 col-md-6 col-lg-4 mb-5">
          <div>
            <span
              className="me-4 d-flex justify-content-center align-items-center mb-4 rounded-circle bg-primary text-light"
            ...
            <h4 className="fw-bold">Neque porro quisquam est</h4>
